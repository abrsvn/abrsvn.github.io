...
uncurry3 :: (c -> b -> a -> d) -> (a, b, c) -> d
uncurry3 f (x,y,z) =  f z y x
...
intVP (VP2 dv np1 np2) = \ subj -> intNP np1 (\ iobj -> intNP np2 (\ dobj -> intDV dv dobj iobj subj))
